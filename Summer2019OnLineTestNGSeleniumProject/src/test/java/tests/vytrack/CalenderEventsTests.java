...
public class CalenderEventsTests {
    ...
    public void setup(){
        ...
        driver.findElement(By.name("_submit")).submit();
    ...
    @Test(description = "Create Calendar event button is isDisplayed")
    public void test2(){
        Assert.assertTrue(driver.findElement(By.linkText("Create Calendar Event")).isDisplayed());
    }
